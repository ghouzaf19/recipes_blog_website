...
export const COOKETRICKS_CONTENT_REGISTRY = {
  ...
  clusters: [
    {
      id: "cluster_weeknight_dinners_by_method",
      pillarId: "pillar_weeknight_dinners",
      title: "Quick Weeknight Dinners by Cooking Method",
      slug: "quick-weeknight-dinners-by-method",
      searchIntent: "informational and transactional",
    },
  ],
  articles: [
    {
      id: "article_quick_weeknight_dinners",
      projectId: COOKETRICKS_PROJECT_ID,
      pillarId: "pillar_weeknight_dinners",
      clusterId: "cluster_weeknight_dinners_by_method",
      title:
        "Quick Weeknight Dinners: Choose the Right Method for the Time You Have",
      slug: "quick-weeknight-dinners",
      primaryKeyword: "quick weeknight dinners",
      secondaryKeywords: [],
    ...
    {
      id: "article_one_pot_tomato_spinach_pasta",
      projectId: COOKETRICKS_PROJECT_ID,
      pillarId: "pillar_weeknight_dinners",
      clusterId: "cluster_weeknight_dinners_by_method",
      title: "One-Pot Tomato Spinach Pasta for Weeknights",
      slug: "one-pot-tomato-spinach-pasta",
      primaryKeyword: "one-pot tomato spinach pasta",
      secondaryKeywords: [],
    ...
    {
      id: "article_garlic_butter_shrimp_rice_skillet",
      projectId: COOKETRICKS_PROJECT_ID,
      pillarId: "pillar_weeknight_dinners",
      clusterId: "cluster_weeknight_dinners_by_method",
      title: "Garlic Butter Shrimp and Rice Skillet",
      slug: "garlic-butter-shrimp-rice-skillet",
      primaryKeyword: "garlic butter shrimp and rice skillet",
      secondaryKeywords: [],
      searchIntent: "transactional",
      contentType: "recipe",
      seo: { tags: [] },
    ...
    {
      id: "article_ground_beef_broccoli_stir_fry",
      projectId: COOKETRICKS_PROJECT_ID,
      pillarId: "pillar_weeknight_dinners",
      clusterId: "cluster_weeknight_dinners_by_method",
      title: "Ground Beef and Broccoli Stir-Fry",
      slug: "ground-beef-broccoli-stir-fry",
      primaryKeyword: "ground beef and broccoli stir-fry",
      secondaryKeywords: [],
      searchIntent: "transactional",
      contentType: "recipe",
      seo: { tags: [] },
    ...
    {
      id: "article_sheet_pan_sausage_peppers_onions",
      projectId: COOKETRICKS_PROJECT_ID,
      pillarId: "pillar_weeknight_dinners",
      clusterId: "cluster_weeknight_dinners_by_method",
      title: "Sheet-Pan Sausage, Peppers, and Onions",
      slug: "sheet-pan-sausage-peppers-onions",
      primaryKeyword: "sheet-pan sausage peppers and onions",
      secondaryKeywords: [],
      searchIntent: "transactional",
      contentType: "recipe",
      seo: { tags: [] },
    ...
    {
      id: "article_black_bean_sweet_potato_taco_skillet",
      projectId: COOKETRICKS_PROJECT_ID,
      pillarId: "pillar_weeknight_dinners",
      clusterId: "cluster_weeknight_dinners_by_method",
      title: "Black Bean and Sweet Potato Taco Skillet",
      slug: "black-bean-sweet-potato-taco-skillet",
      primaryKeyword: "black bean and sweet potato taco skillet",
      secondaryKeywords: [],
      searchIntent: "transactional",
      contentType: "recipe",
      seo: { tags: [] },
    ...
    {
      id: "article_sheet_pan_salmon_green_beans_potatoes",
      projectId: COOKETRICKS_PROJECT_ID,
      pillarId: "pillar_weeknight_dinners",
      clusterId: "cluster_weeknight_dinners_by_method",
      title: "Sheet-Pan Salmon with Green Beans and Potatoes",
      slug: "sheet-pan-salmon-green-beans-potatoes",
      primaryKeyword: "sheet-pan salmon with green beans and potatoes",
      secondaryKeywords: [],
      searchIntent: "transactional",
      contentType: "recipe",
      seo: { tags: [] },
    ...
    {
      id: "article_crispy_tofu_mushroom_stir_fry",
      projectId: COOKETRICKS_PROJECT_ID,
      pillarId: "pillar_weeknight_dinners",
      clusterId: "cluster_weeknight_dinners_by_method",
      title: "Crispy Tofu and Mushroom Stir-Fry",
      slug: "crispy-tofu-mushroom-stir-fry",
      primaryKeyword: "crispy tofu and mushroom stir-fry",
      secondaryKeywords: [],
      searchIntent: "transactional",
      contentType: "recipe",
      seo: { tags: [] },
  ...
  contentLinks: [
    {
      id: "link_quick_weeknight_dinners_to_one_pot_tomato_spinach_pasta",
      sourceArticleId: "article_quick_weeknight_dinners",
      targetType: "article",
      targetId: "article_one_pot_tomato_spinach_pasta",
      relationship: "sibling-cluster",
      status: "suggested",
    },
    {
      id: "link_one_pot_tomato_spinach_pasta_to_quick_weeknight_dinners",
      sourceArticleId: "article_one_pot_tomato_spinach_pasta",
      targetType: "article",
      targetId: "article_quick_weeknight_dinners",
      relationship: "sibling-cluster",
      status: "suggested",
    },
    {
      id: "link_quick_weeknight_dinners_to_garlic_butter_shrimp_rice_skillet",
      sourceArticleId: "article_quick_weeknight_dinners",
      targetType: "article",
      targetId: "article_garlic_butter_shrimp_rice_skillet",
      relationship: "sibling-cluster",
      status: "suggested",
    },
    {
      id: "link_garlic_butter_shrimp_rice_skillet_to_quick_weeknight_dinners",
      sourceArticleId: "article_garlic_butter_shrimp_rice_skillet",
      targetType: "article",
      targetId: "article_quick_weeknight_dinners",
      relationship: "sibling-cluster",
      status: "suggested",
    ...
    {
      id: "link_quick_weeknight_dinners_to_ground_beef_broccoli_stir_fry",
      sourceArticleId: "article_quick_weeknight_dinners",
      targetType: "article",
      targetId: "article_ground_beef_broccoli_stir_fry",
      relationship: "sibling-cluster",
      status: "suggested",
    },
    {
      id: "link_ground_beef_broccoli_stir_fry_to_quick_weeknight_dinners",
      sourceArticleId: "article_ground_beef_broccoli_stir_fry",
      targetType: "article",
      targetId: "article_quick_weeknight_dinners",
      relationship: "sibling-cluster",
      status: "suggested",
    ...
    {
      id: "link_quick_weeknight_dinners_to_sheet_pan_sausage_peppers_onions",
      sourceArticleId: "article_quick_weeknight_dinners",
      targetType: "article",
      targetId: "article_sheet_pan_sausage_peppers_onions",
      relationship: "sibling-cluster",
      status: "suggested",
    },
    {
      id: "link_sheet_pan_sausage_peppers_onions_to_quick_weeknight_dinners",
      sourceArticleId: "article_sheet_pan_sausage_peppers_onions",
      targetType: "article",
      targetId: "article_quick_weeknight_dinners",
      relationship: "sibling-cluster",
      status: "suggested",
    ...
    {
      id: "link_quick_weeknight_dinners_to_black_bean_sweet_potato_taco_skillet",
      sourceArticleId: "article_quick_weeknight_dinners",
      targetType: "article",
      targetId: "article_black_bean_sweet_potato_taco_skillet",
      relationship: "sibling-cluster",
      status: "suggested",
    },
    {
      id: "link_black_bean_sweet_potato_taco_skillet_to_quick_weeknight_dinners",
      sourceArticleId: "article_black_bean_sweet_potato_taco_skillet",
      targetType: "article",
      targetId: "article_quick_weeknight_dinners",
      relationship: "sibling-cluster",
      status: "suggested",
    ...
    {
      id: "link_quick_weeknight_dinners_to_sheet_pan_salmon_green_beans_potatoes",
      sourceArticleId: "article_quick_weeknight_dinners",
      targetType: "article",
      targetId: "article_sheet_pan_salmon_green_beans_potatoes",
      relationship: "sibling-cluster",
      status: "suggested",
    },
    {
      id: "link_sheet_pan_salmon_green_beans_potatoes_to_quick_weeknight_dinners",
      sourceArticleId: "article_sheet_pan_salmon_green_beans_potatoes",
      targetType: "article",
      targetId: "article_quick_weeknight_dinners",
      relationship: "sibling-cluster",
      status: "suggested",
    ...
    {
      id: "link_quick_weeknight_dinners_to_crispy_tofu_mushroom_stir_fry",
      sourceArticleId: "article_quick_weeknight_dinners",
      targetType: "article",
      targetId: "article_crispy_tofu_mushroom_stir_fry",
      relationship: "sibling-cluster",
      status: "suggested",
    },
    {
      id: "link_crispy_tofu_mushroom_stir_fry_to_quick_weeknight_dinners",
      sourceArticleId: "article_crispy_tofu_mushroom_stir_fry",
      targetType: "article",
      targetId: "article_quick_weeknight_dinners",
      relationship: "sibling-cluster",
      status: "suggested",
