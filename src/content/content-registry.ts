...
export const COOKETRICKS_CONTENT_REGISTRY = {
  ...
  contentLinks: [
    {
      id: "link_quick_weeknight_dinners_to_one_pot_zucchini_tomato_penne",
      sourceArticleId: "article_quick_weeknight_dinners",
      targetType: "article",
      targetId: "article_one_pot_zucchini_tomato_penne",
      relationship: "sibling-cluster",
      status: "suggested",
    },
    {
      id: "link_one_pot_zucchini_tomato_penne_to_quick_weeknight_dinners",
      sourceArticleId: "article_one_pot_zucchini_tomato_penne",
      targetType: "article",
